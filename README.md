...
- [GDM Settings](https://github.com/gdm-settings/gdm-settings): A settings app for GDM (GNOME's Login Manager)
- [Daikhan](https://gitlab.com/daikhan/daikhan): A minimal but intuitive media player for Linux
...
- [easier-linux](https://github.com/realmazharhussain/easier-linux): Makes your Linux system easier-to-use by adding a bunch of options you didn't have before
### Archived
- [plymouth-theme-softwaves-manjaro](https://github.com/realmazharhussain/plymouth-theme-softwaves-manjaro): 'Softwaves' Plymouth theme (usually found in Debian) with Manjaro branding
